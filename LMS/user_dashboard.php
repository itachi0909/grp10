...
<body>
	...
	<div class="row cards1">
		<div class="col-md-3 align" style="margin: 25px">
			<div class="card bg-light align1" style="width: 300px">
		...
		<div class="col-md-3 align" style="margin: 0px">
			<div class="card bg-light align1" style="width: 300px">
				<div class="card-header">Total Book</div>
				<div class="card-body">
					<p class="card-text">No of books available: <?php echo get_book_count();?></p>
					<a class="btn btn-success" href="admin/Regbooks.php" target="_blank">View All Books</a>
				</div>
			</div>
		</div>
		<div class="col-md-3 align" style="margin: 0px">
			<div class="card bg-light align1" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-warning" href="admin/Regcat.php" target="_blank">View Categories</a>
				</div>
			</div>
		</div>
